...
if __name__ == "__main__":
    ...
    attack_list = []        
    for attackID, attackValue in enumerate(df['label']):    #     
        if df['label'].iloc[attackID] == 'normal.':
            attack_list.append("Normal")
        else:
            attack_list.append("Attack")
    df['attack'] = attack_list
    # print(f"df: \n{df.head(10)}\n")
